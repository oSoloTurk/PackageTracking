        ...
        <div class="container py-5">
          <div class="d-flex justify-content-center">
            <div class="col-md-3 text-center">
              <span class="display-6">' . $GLOBALS['messages_footer']['FOOTER_COPYRIGHT_UP_ROW'] . '</span><br>
              <span class="display-7">' . $GLOBALS['messages_footer']['FOOTER_COPYRIGHT_DOWN_ROW'] . '</span>
