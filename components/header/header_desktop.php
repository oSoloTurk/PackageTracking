<?php 
  if($GLOBALS['login']) {
    ...
    if (hasRole("PROFILE_EFFECTED")) {
      $button_9 = '<a class="dropdown-item bg-dark" id="btn-effected" href="profil.php?tab=btn-effected">Hesabın üzerindeki işlemler</a>';
    } else $button_9 = '';
    if (hasRole("PROFILE_EFFECTER")) {
      $button_10 = '<a class="dropdown-item bg-dark" id="btn-effecter" href="profil.php?tab=btn-effecter">Yaptığın İşlemler</a>';
    } else $button_10 = '';
